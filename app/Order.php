...
class Order extends Model
{
  ...
  protected $fillable = [//Model::createでデータをinsertする際に許可する項目
  ...
  {
    return $this->belongsToMany('App\Product')->withPivot('quantity'); //withPivotメソッドは中間テーブルのOrderProductのquantityカラムを取得することができる
  }
}
